...
class EmojiiMemoryGameVM: ObservableObject {
    ...
    private static let possibleThemes¨: [Theme] = [
        Theme(name: "Halloween", emojis¨: "👻🎃🕷🧙‍♀️🧹🕯🦇🌗🍭🧛🏻👀🙀", pairsToShow: 7, fill: [.red, .orange, Color(#colorLiteral(red: 1, green: 0.7764705882, blue: 0, alpha: 1))]),
        ...
        Theme(name: "Beach", emojis¨: "🏝🏖⛵️🤿🎣🚣‍♀️⚓️🚤🌞🪁🏊‍♂️", pairsToShow: 5, fill: [Color(#colorLiteral(red: 0.9686274529, green: 0.7668460586, blue: 0.3002265522, alpha: 1)), Color(#colorLiteral(red: 0.9686274529, green: 0.78039217, blue: 0.3450980484, alpha: 1)), Color(#colorLiteral(red: 0.5310901402, green: 0.8380914645, blue: 0.9686274529, alpha: 1)), Color(#colorLiteral(red: 0.3248517906, green: 0.7765617937, blue: 0.9686274529, alpha: 1)), Color(#colorLiteral(red: 0.2588235438, green: 0.7568627596, blue: 0.9686274529, alpha: 1))]),
        Theme(name: "Red", emojis¨: "🏓🚗🚒⛽️☎️🧲🎈📍⛔️‼️♥️🍎🍓🍄", pairsToShow: 5, fill: [.red]),
        Theme(name: "Plants", emojis¨: "🌵🌳🍀💐🌻🌹🌱🌿🌴🌲", pairsToShow: 7, fill: [Color(#colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1))]),
